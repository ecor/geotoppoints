...
wpath <- '/Volumes/My\ Passport/Trentino_500_dstr_GEOtop_1_225_9_007/Trentino_500_dstr_GEOtop_1_225_9_007' ## ENTER GEOTOP SIMULATION PATH
ContinuousRecovery <- 7


## toponyms of the check pints 


points <- c("BONDONE","LAVARONE","SAVIGNANO")
points_meteoid <- c("T0327","T0082","T0147") ## T0147 ROVERETO 
...
tz <- "A"
start <- as.POSIXct("2000-02-01 UTC",tz=tz)
end <- as.POSIXct("2006-02-28 UTC",tz=tz)
day <- 3600*24
...
id <- c("Prain_over_canopy.mm.","Prain_under_canopy.mm.","LE.W.m2.")
...
pointvalues_melt <- rbind(pointvalues_melt,psiliq_melt)
